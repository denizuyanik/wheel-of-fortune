    ...
    return json(
      {
        ...
        centerText: result.campaign.centerText ?? 'GOOD LUCK',
        centerColor: result.campaign.centerColor ?? '#171923',
        centerTextColor: result.campaign.centerTextColor ?? '#ffffff',
        centerImageUrl: result.campaign.centerImageUrl ?? '',
